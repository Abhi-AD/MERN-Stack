...
const UpdateProfileDialog = ({ open, setOpen }) => {
     ...
     const [input, setInput] = useState({
          ...
          skills: user?.profile?.skills?.map(skill => skill) || "", //arrays skill
     ...
     const submitHandler = async (e) => {
          ...
          try {
               setLoading(true);
               const updateuser = await axios.patch(`${apiUrl}/user/profile/update`, formData, {
                    headers: {
                              ...
                              <DialogFooter>
                                   {
                                        loading ? <Button className="w-full my-4  bg-[#00c0e4] hover:bg-[#063748]"><Loader2 className="mr-2 h-4 w-4 animate-spin" />Please wait</Button>
                                             :
                                             <Button type="submit" className="w-full my-4  bg-[#00c0e4] hover:bg-[#063748]">Update</Button>
                                   }
                              </DialogFooter>
                         </form>
                    </DialogContent>
